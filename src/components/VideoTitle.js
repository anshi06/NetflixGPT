const VideoTitle = ({ title, overview }) => {
  return (
    <div className="px-6 md:px-24 absolute bg-gradient-to-r from-black text-white pt-[20%] overflow-hidden w-full aspect-video">
      <h1 className="text-2xl md:text-6xl font-bold">{title}</h1>
      <p className="hidden md:inline-block py-6 w-1/3">
        {overview ||
